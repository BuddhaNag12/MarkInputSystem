      ...
      <div class="text-center">
        <v-dialog v-model="dialog" width="500">
          <v-card>
            ...
            <v-card-text>
              <v-alert type="success">Marks Added</v-alert>
            </v-card-text>
              ...
              <template v-slot:default>
                <tbody>
                  <tr v-for="(row, index) in rows" :key="index">
                    <td>
                      <v-text-field v-model="row.regNo" label="Enter Registration No./Roll no."></v-text-field>
                    </td>
                    <td>
                      <v-text-field v-model="row.mark" label="Enter Unit Test  Mark 20/14"></v-text-field>
                    </td>
                    <td>
                      <v-text-field v-model="row.AtMark" label="Enter Attendence mark 10/6"></v-text-field>
                    </td>
                    <td>
